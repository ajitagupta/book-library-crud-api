...
In this bootcamp we build a Book / Library CRUD API from the ground up according to microservice architecture. To this end, we create five Spring Boot projects:
1. Config Client
2. Config Server
3. Feign Consumer
